...
///Mirco Zeiss
///https://github.com/zemirco/swift-linechart MIT license
/// this is being changed a bit
...
class LineChart: UIControl {
    ...
    override func drawRect(rect: CGRect) {
        ...
        for (lineIndex, lineData) in enumerate(dataStore) {
            ...
            var painLine = painDataStore[lineIndex]
            drawLine(scaledDataXAxis, yAxis: scaledDataYAxis, lineIndex: lineIndex)
            
            // draw dots
            if dotsVisible { drawDataDots(scaledDataXAxis, yAxis: scaledDataYAxis, pain:painLine, lineIndex: lineIndex) }
    ...
    */
    func drawDataDots(xAxis: Array<CGFloat>, yAxis: Array<CGFloat>, pain: Array<CGFloat>, lineIndex: Int) {
        ...
        for index in 0..<xAxis.count {
            ...
            // draw custom layer with another layer in the center
                ...
                dotLayer.dotInnerColor = colors[3]
